...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.56.0 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.68.0 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.297.0 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/oam v1.23.15 // @grafana/data-sources-plugins
	github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi v1.31.10 // @grafana/data-sources-plugins
